...
def cmd_runtime_test(args: argparse.Namespace) -> int:
    ...
    if args.runtime == "openclaw":
        ...
        oc = Path("/Users/shift/openclaw/scripts/oc")
        ...
        checks.append({"path": "/Users/shift/.hermes", "available": Path("/Users/shift/.hermes").exists()})
    elif args.runtime == "codex":
        checks.append(check_command("codex"))
        checks.append({"path": "/Users/shift/openclaw/workspace-xmanx/projects/openclaw-codex-controller", "available": Path("/Users/shift/openclaw/workspace-xmanx/projects/openclaw-codex-controller").exists()})
...
def build_parser() -> argparse.ArgumentParser:
    ...
    emp_import_openclaw.add_argument("--config", default="/Users/shift/openclaw/openclaw.json")
