...
Default actor is `owner-shift`. Write actions must show disabled/loading state while pending so repeated owner clicks cannot create duplicate approval requests.
