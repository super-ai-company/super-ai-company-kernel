...
<script>
  ...
  document.getElementById('db-path-label').innerText = isSimulationMode ? 'simulation://gateway.company.internal' : 'https://gateway.company.internal';
        ...
        self.assertNotIn("/Users/shift/Documents/anti/company.sqlite", html)
    ...
    def test_launchd_service_plists_pin_api_and_dashboard_ports(self) -> None:
        ...
        self.assertEqual(
            ["/Users/shift/openclaw/company-kernel/bin/company-api-gateway", "--host", "127.0.0.1", "--port", "8765", "--quiet"],
            api["ProgramArguments"],
        )
        self.assertEqual(["/Users/shift/openclaw/company-kernel/bin/company-dashboard-server"], dashboard["ProgramArguments"])
